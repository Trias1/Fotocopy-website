...
<head>
    ...
    <title>Welcome to Fotocopy</title>
...
<body>
<img src="<?php echo base_url().'assets/img/bc.jpg'?>" alt="gambar" class="bg" />
    <!-- Navigation -->
   <?php 
   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header" style="color:#fcc;">Welcome to Fotocopy
                </h1>
            </div>
        </div>
        <!-- /.row -->
